...
to setup
  clear-all
  clear-all-plots
  resize-world (- wsize) / 2 wsize / 2 (- wsize) / 2 wsize / 2
...
to solve1
  ...
  [
    ask turtles
    [
      while [((patch-right-and-ahead 90 1 = nobody or [pcolor = white] of patch-right-and-ahead 90 1) and patch-ahead 1 != nobody) and [pcolor != white] of patch-ahead 1]
        [
          fd 1 ;;oso yparxei toixos de3ia kai oxi mprosta proxwra
      ]
      ifelse (patch-right-and-ahead 90 1 = nobody or [pcolor = white] of patch-right-and-ahead 90 1) and (patch-left-and-ahead 90 1 = nobody or [pcolor = white] of patch-left-and-ahead 90 1)
      [
        set heading heading + 180
      ]
      [
        ifelse not (patch-right-and-ahead 90 1 = nobody or [pcolor = white] of patch-right-and-ahead 90 1)
        [
          set heading heading + 90
          fd 1 ;;an den yparxei keno h toixos de3ia stripse de3ia
        ]
        [
          ifelse (patch-left-and-ahead 90 1 != nobody or [pcolor != white] of patch-left-and-ahead 90 1)
          [
            set heading heading - 90
            fd 1
          ]
...
to solve2
  ...
  [
    ...
    [
      ...
      while [patch-ahead 1 != nobody and [pcolor = white] of patch-ahead 1]
      [
  ...
  [
    ...
    [
      ...
      [
        ...
        [ fd 1
          if pcolor = red [set x2 1]
          hatch 1 [set heading  heading - 90 ]
          hatch 1 [set heading heading + 90  ]
        ]                  ;; Otherwise, its safe to go foward.
      ]
      [
        ask self [ die ]
      ]
    ]
    ask turtles with[[explored] of patch-here = 1 ]  [die]
    ask patches with [any? turtles-here]
    [
      set explored 1
      ask turtles-on self[die]
